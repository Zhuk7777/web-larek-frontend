...
* updateData(data: Partial\<IPage\>) - обновление данных страницы
...
* data:downloaded - полученние данных с сервера
* modal:open - открытие модального окна
* modal:close - закрытие модального окна
* card:addToBasket - добавление товара в коризну
...
* order:errors - ошибки при оформлении заказа
